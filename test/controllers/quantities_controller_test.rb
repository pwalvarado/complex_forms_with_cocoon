...
class QuantitiesControllerTest < ActionController::TestCase
  ...
  test "should create quantity" do
    assert_difference('Quantity.count') do
      post :create, quantity: { amount: @quantity.amount, ingredient_id: @quantity.ingredient_id, recipe_id: @quantity.recipe_id }
    end
  ...
  test "should update quantity" do
    patch :update, id: @quantity, quantity: { amount: @quantity.amount, ingredient_id: @quantity.ingredient_id, recipe_id: @quantity.recipe_id }
    assert_redirected_to quantity_path(assigns(:quantity))
  end
